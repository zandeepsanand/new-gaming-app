...
@Component({
  selector: 'app-view-subscriber-profile',
  templateUrl: './view-subscriber-profile.component.html',
  styleUrls: ['./view-subscriber-profile.component.scss'],
  providers: [UploadService]
})
export class ViewSubscriberProfileComponent implements OnInit {
  user:any
